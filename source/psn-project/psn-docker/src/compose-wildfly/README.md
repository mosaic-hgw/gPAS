...
Zusätzlich braucht nur der Wert der ENV-Variable `GPAS_AUTH_MODE` auf *keycloak-json* gesetzt werden und der WildFly bezieht die KeyCloak-Credentials aus der JSON-Datei.
