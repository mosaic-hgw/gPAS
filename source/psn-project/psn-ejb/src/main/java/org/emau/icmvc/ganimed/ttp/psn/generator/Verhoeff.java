...
/**
 * check digit generation and validation (verhoeff-algorithm)<br>
 * see Neal R. Wagner (http://www.cs.utsa.edu/~wagner/laws/AVerhoeffErrorDetection.html)
 * 
 * @author geidell
 */
public class Verhoeff extends CheckDigits {
	...
	private static final Logger logger = Logger.getLogger(Verhoeff.class);

	public Verhoeff(Alphabet alphabet, Map<GeneratorProperties, String> properties) throws InvalidAlphabetException {
