...
class DashboardControllerTest extends gPASWebTest
{
	@InjectMocks
	...
	@Test
	void initWithEmptyStats()
	{
		// Arrange
		when(statisticManager.getLatestStats()).thenReturn(new StatisticDTO());
		
		// Act
		dashboardController.init();
		
		// Assert
		assertEquals(0, dashboardController.getDomains().size());
	}
}
