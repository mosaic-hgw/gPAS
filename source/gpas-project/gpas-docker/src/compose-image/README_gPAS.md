...
---
**Hinweis:** Diese README beschäftigt sich nur mit dem Ausführen des gPAS`s, Mittels vorhandenem gPAS-Image (${docker.image.name}). Zum Einsatz kommt nur Docker-Compose.
...
#### ./envs/ttp_gpas.env **<-- ehemals gpas.env**
| Kategorie | Variable                                                | verfügbare Werte oder Schema           | default                                             |
|-----------|---------------------------------------------------------|----------------------------------------|-----------------------------------------------------|
| Logging   | TTP_GPAS_LOG_TO **<-- ehemals TTP_GPAS_LOG_TO_FILE**    | CONSOLE;FILE                           | CONSOLE                                             |
