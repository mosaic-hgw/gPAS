...
public class PSNManagerWithNotificationBean extends PSNManagerBase implements PSNManagerWithNotification
{
	...
	@Override
	public String createPseudonymFor(String notificationClientID, String value, String domainName)
			throws DomainIsFullException, InvalidParameterException, UnknownDomainException
	{
		return super.createPseudonymFor(notificationClientID, value, domainName);
	}

	@Override
	public List<String> createPseudonymsFor(String notificationClientID, String value, String domainName, int number)
			throws DomainIsFullException, InvalidParameterException, UnknownDomainException
	{
		return super.createPseudonymsFor(notificationClientID, value, domainName, number);
	}

	@Override
	public Map<String, String> createPseudonymForList(String notificationClientID, Set<String> values, String domainName)
			throws DomainIsFullException, InvalidParameterException, UnknownDomainException
	{
		return super.createPseudonymForList(notificationClientID, values, domainName);
	}

	@Override
	public Map<String, List<String>> createPseudonymsForList(String notificationClientID, Set<String> values, String domainName, int number)
			throws DomainIsFullException, InvalidParameterException, UnknownDomainException
	{
		return super.createPseudonymsForList(notificationClientID, values, domainName, number);
	}
	...
	@Override
	public List<String> getOrCreatePseudonymsFor(String notificationClientID, String value, String domainName, int minNumber)
			throws InvalidParameterException, DomainIsFullException, UnknownDomainException
	{
		return super.getOrCreatePseudonymsFor(notificationClientID, value, domainName, minNumber);
	}
	...
	@Override
	public Map<String, List<String>> getOrCreatePseudonymsForList(String notificationClientID, Set<String> values, String domainName, int minNumber)
			throws DomainIsFullException, InvalidParameterException, UnknownDomainException
	{
		return super.getOrCreatePseudonymsForList(notificationClientID, values, domainName, minNumber);
	}
	...
	@Override
	public void anonymiseAllEntriesForValue(String notificationClientID, String value, String domainName)
			throws DBException, InvalidParameterException, UnknownDomainException, UnknownValueException, ValueIsAnonymisedException
	{
		super.anonymiseAllEntriesForValue(notificationClientID, value, domainName);
	}

	@Override
	public Map<String, AnonymisationResult> anonymiseAllEntriesForValues(String notificationClientID, Set<String> values, String domainName)
			throws DBException, InvalidParameterException, UnknownDomainException
	{
		return super.anonymiseAllEntriesForValues(notificationClientID, values, domainName);
	}

	@Override
	public void anonymisePseudonym(String notificationClientID, String psn, String domainName)
			throws DBException, InvalidParameterException, UnknownDomainException, InvalidPSNException, PSNNotFoundException
	{
		super.anonymisePseudonym(notificationClientID, psn, domainName);
	}

	@Override
	public Map<String, AnonymisationResult> anonymisePseudonyms(String notificationClientID, Set<String> psns, String domainName)
			throws DBException, InvalidParameterException, UnknownDomainException
	{
		return super.anonymisePseudonyms(notificationClientID, psns, domainName);
	}
	...
	@Override
	public void deleteAllEntriesForValue(String notificationClientID, String value, String domainName)
			throws DeletionForbiddenException, InvalidParameterException, UnknownDomainException, UnknownValueException
	{
		super.deleteAllEntriesForValue(notificationClientID, value, domainName);
	}

	@Override
	public Map<String, DeletionResult> deleteAllEntriesForValues(String notificationClientID, Set<String> values, String domainName)
			throws DeletionForbiddenException, InvalidParameterException, UnknownDomainException
	{
		return super.deleteAllEntriesForValues(notificationClientID, values, domainName);
	}

	@Override
	public void deletePseudonym(String notificationClientID, String psn, String domainName)
	...
	{
		super.deletePseudonym(notificationClientID, psn, domainName);
	}

	@Override
	public Map<String, DeletionResult> deletePseudonyms(String notificationClientID, Set<String> psns, String domainName)
			throws DeletionForbiddenException, InvalidParameterException, UnknownDomainException
	{
		return super.deletePseudonyms(notificationClientID, psns, domainName);
	}
	...
	@Override
	public List<InsertPairExceptionDTO> insertValuePseudonymPairs(String notificationClientID, List<StringPair> pairs, String domainName)
