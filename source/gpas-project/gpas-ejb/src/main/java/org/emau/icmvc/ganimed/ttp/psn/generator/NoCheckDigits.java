...
{
	@Serial
	private static final long serialVersionUID = 7248871614475266342L;

	public NoCheckDigits()
	{
	}

	public NoCheckDigits(Alphabet alphabet, DomainConfig config)
	{
		super(alphabet);
	...
	{
		return Math.min(getMaxMessageLength(), total);
	}
}
