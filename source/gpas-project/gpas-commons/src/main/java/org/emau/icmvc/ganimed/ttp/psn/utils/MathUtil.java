...
{
	/**
	 * {@return an array with all prime factors of the given number}
	 * <p>
	...
	public static int getMaxPrimeFactorsFor(int number)
	{
		/*
	...
	/**
	 * {@return true, if the given number is a prime power}
	 * @param number the number to test
	 */
