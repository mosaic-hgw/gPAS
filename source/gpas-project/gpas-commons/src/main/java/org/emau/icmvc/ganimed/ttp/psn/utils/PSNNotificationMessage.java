...
public class PSNNotificationMessage extends NotificationMessage
{
	...
	private List<Map.Entry<String, String>> insertionRequest;
	...
	public List<Map.Entry<String, String>> getInsertionRequest()
	{
		return insertionRequest;
	}

	public void setInsertionRequest(List<Map.Entry<String, String>>	insertionRequest)
	{
