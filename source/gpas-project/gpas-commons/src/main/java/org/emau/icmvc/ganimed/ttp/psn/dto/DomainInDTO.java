...
{
	@Serial
	private static final long serialVersionUID = 2742471770311637648L;
	...
	/* imho this should be part of domain config instead of being an attribute of domain */
	...
	public void setCheckDigitClass(Class<? extends CheckDigits> checkDigitClass)
	{
		...
		{
			setCheckDigitClass(checkDigitClass.getName());
		}
	}
	...
	public void setAlphabetClass(Class<? extends Alphabet> alphabetClass)
	{
		...
		{
			setAlphabet(alphabetClass.getName());
		}
	}
	...
	@Override
	public int compareTo(DomainInDTO o)
	{
