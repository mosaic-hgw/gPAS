...
public interface DomainManager
{
	 ...
	 */
	void addDomain(
			@XmlElement(required = true) @WebParam(name = "domainDTO") DomainInDTO domainDTO)
	...
	void updateDomainInUse(
			...
			@XmlElement(required = true) @WebParam(name = "parentDomainNames") List<String> parentDomainNames,
	...
	/**
	 * {@return true if the property {@link DomainProperties#PSNS_DELETABLE} is set}
	 *
	...
	/**
	 * {@return the alphabet for the given name} If you have access to the common API of gPAS in particular to
	 * {@link org.emau.icmvc.ganimed.ttp.psn.alphabets.Alphabets} you should prefer using
	 * {@link org.emau.icmvc.ganimed.ttp.psn.alphabets.Alphabets#createAlphabet(String)} instead of calling the service.
	 * @param alphabetName the alphabet string, either a class name, a comma-separated list of characters, or a single character
	 * @throws InvalidParameterException for an invalid alphabet name (e.g. null or empty)
	 * @throws InvalidAlphabetException for an invalid alphabet
	 */
	Alphabet getAlphabet(
			@XmlElement(required = true) @WebParam(name = "alphabetName") String alphabetName)
