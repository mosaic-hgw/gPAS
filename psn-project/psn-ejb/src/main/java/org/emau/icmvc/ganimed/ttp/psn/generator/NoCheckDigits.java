...
/**
 * simple class, with generates no check digits - the methods just compare the chars of the given string with the alphabet
 * 
 * @author geidell
 */
public class NoCheckDigits extends CheckDigits {

	private static final Logger logger = Logger.getLogger(NoCheckDigits.class);

	public NoCheckDigits(Alphabet alphabet, Map<GeneratorProperties, String> properties) throws InvalidAlphabetException {
